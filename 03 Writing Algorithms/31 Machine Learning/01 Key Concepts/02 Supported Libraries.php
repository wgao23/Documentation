...
$libraries = array(
    ...
    new MachineLearningLibraryForWritingAlgorithm("Keras", "3.7.0", "Python", "import keras", "https://keras.io/", "https://github.com/QuantConnect/Lean/blob/master/Algorithm.Python/KerasNeuralNetworkAlgorithm.py"),
    ...
    new MachineLearningLibraryForWritingAlgorithm("fastai", "2.7.18", "Python", "import fastai", "https://docs.fast.ai/", ""),
    ...
    new MachineLearningLibraryForWritingAlgorithm("XGBoost", "2.1.3", "Python", "import xgboost", "https://xgboost.readthedocs.io/en/latest/", ""),
